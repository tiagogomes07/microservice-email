...
app.get('/enviar/:email/:titulo/:assunto/:repetir?', function(req, res) {
    ...
    if(repetir){
      ...
      email.send(req.params.email,req.params.titulo,req.params.assunto).then( function(){
        console.log(x);
...
//crud templates
app.post('/template/cadastrar/:alias/:titulo/:corpo', function(req, res) {
...
app.get('/template/cadastrar/:alias/:titulo/:corpo', function(req, res) {
  emailTemplateCrud.create(req.params.titulo,req.params.alias,req.params.corpo)
  res.send(`Cadastrado com sucesso!`)              
});
...
app.put('/template/update/:alias/:titulo/:corpo', function(req, res) {
  emailTemplateCrud.updateEmailAlias(req.params.titulo,req.params.alias,req.params.corpo)
